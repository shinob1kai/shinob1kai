...
### 👨‍💻 About Me
Self-taught dev who likes building tools that solve one problem well — local AI image generation, database editors, Android utilities, Minecraft mods. Currently tinkering with a Windows taskbar tool (C#/WPF).
